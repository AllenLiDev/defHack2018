...
const SKILL_NAME = 'Recycling Facts';
...
const data = [
    ...
    'U.S. recycling levels are currently only 21.4%',
    ...
    'Manufacturers truly want these materials back to reuse in their manufacturing, but they arent able to reuse the materials if people dont recycle right.',
